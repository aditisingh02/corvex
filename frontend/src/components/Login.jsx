...
const Login = () => {
  ...
  // Demo users for testing - actual seeded accounts
  const demoUsers = [
    { 
    ...
    { 
      ...
      name: 'Mike Chen', 
      role: 'hr_coordinator',
      description: 'HR coordination and support'
    },
    { 
      ...
      <div className="w-full lg:w-2/5 flex items-center justify-start p-8 lg:pl-16">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-4">
            ...
            {showDemoUsers && (
              <div className="space-y-2 bg-white border border-gray-200 rounded-xl p-4 max-h-96 overflow-y-auto">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {demoUsers.map((demoUser) => (
                    <button
                      ...
                      className="w-full text-left p-3 border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-[#5E17EB] transition-colors group"
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-2 mb-1">
                            <div className="text-sm font-medium text-gray-900 group-hover:text-[#5E17EB] truncate">
                              {demoUser.name}
                            </div>
                            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium
                              ${demoUser.role === 'super_admin' ? 'bg-purple-100 text-purple-800' :
                                demoUser.role === 'hr_manager' ? 'bg-blue-100 text-blue-800' :
                                demoUser.role === 'hr_coordinator' ? 'bg-cyan-100 text-cyan-800' :
                                demoUser.role === 'manager' ? 'bg-green-100 text-green-800' :
                                demoUser.role === 'recruiter' ? 'bg-orange-100 text-orange-800' :
                        ...
                        <div className="ml-2 flex-shrink-0">
                          <svg className="w-4 h-4 text-gray-400 group-hover:text-[#5E17EB]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="text-xs text-blue-800">
                      ...
                      <p className="mt-1">Each role has different access levels. Try the attendance features as an Employee or test HR management as an HR Manager.</p>
                    </div>
                  </div>
                </div>
              </div>
